...
from models.transformer.attention import MultiHeadAttention, MultiHeadAttention_rela
...
class DecoderLayer(Module):
    def __init__(self, d_model=512, d_k=128, d_v=128, h=4, d_ff=2048, dropout=.1, self_att_module=None,
        ...
        self.enc_att = MultiHeadAttention_rela(d_model, d_k, d_v, h, dropout, can_be_stateful=False,
